...
bool CudaThermfield::initiate(size_t N, size_t M, curandRngType_t rngType,
...
bool CudaThermfield::initiateConstants(const fortMatrix<real,1> &temperature, 
		real timestep, real gamma, real k_bolt, real mub, real damping) {
	// Timing
	stopwatch.skip();
