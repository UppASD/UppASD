...
// Constructor
FortranMeasurement::FortranMeasurement(const CudaTensor<real, 3>& p1, const CudaTensor<real, 3>& p2,
...
// Callback
void FortranMeasurement::queue_callback(cudaStream_t, cudaError_t, void* data) {
#ifdef NVPROF
