#ifndef __CUDA_DEPONDT_INTEGRATOR_HPP__
#define __CUDA_DEPONDT_INTEGRATOR_HPP__
...
public:
	...
	// Initiator
	bool initiate(size_t N, size_t M, char _stt, real _timestep, 
	...
	// Algorithm
	void evolveFirst(const cudaMatrix<real,3,3> &beff,
	...
	void evolveSecond(const cudaMatrix<real,3,3> &beff,
