#ifndef __FORT_MATRIX_HPP__
#define __FORT_MATRIX_HPP__
...
public:
	// Constructors
	fortMatrix() {}
	fortMatrix(const hostMatrix<T,D,I,J,K,L> &m) {clone(m);}
	fortMatrix(const fortMatrix<T,D,I,J,K,L> &m) {clone(m);}
	...
	void set(T * d, size_t i)
		{__MAT_TEST_DIM(1); setData(d,i,1,1,1);}
	void set(T * d, size_t i, size_t j)
		{__MAT_TEST_DIM(2); setData(d,i,j,1,1);}
	void set(T * d, size_t i, size_t j, size_t k)
		{__MAT_TEST_DIM(3); setData(d,i,j,k,1);}
	void set(T * d, size_t i, size_t j, size_t k, size_t l)
		{__MAT_TEST_DIM(4); setData(d,i,j,k,l);}
};
