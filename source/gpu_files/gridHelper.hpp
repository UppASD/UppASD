#ifndef __GRID_HELPER_HPP__
#define __GRID_HELPER_HPP__
...
public:
	...
	inline bool dim3d(dim3 * block, dim3 * grid, 
	...
	// 2D-index
	inline static __device__ bool index2d(unsigned int *x, unsigned int *y, 
	...
	// 3D-index
	inline static __device__ bool index3d(unsigned int *x, unsigned int *y, unsigned int *z, 
			unsigned int X, unsigned int Y, unsigned int Z) {
		if (big) {
