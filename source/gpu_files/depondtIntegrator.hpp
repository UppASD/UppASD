#ifndef __DEPONDT_INTEGRATOR_HPP__
#define __DEPONDT_INTEGRATOR_HPP__
...
private:
	...
	void thermfield(hostMatrix<real,2> &mmom, real deltat, 
		const hostMatrix<real,1> &temperature);
...
public:
	...
	// Set up constants
	bool initiateConstants(real gamma_const, real k_bolt_const, 
