   ...
   subroutine sd_mphase_cpu()
      ...
      do while (mstep.LE.rstep+nstep) !+1
         ...
         if(do_sparse=='Y') then
            ...
            call effective_field_cpu(Natom,Mensemble,1,Natom,emomM,   &
         ...
         if(SDEalgh==1.or.SDEalgh==4.or.SDEalgh==5.or.SDEalgh==6.or.SDEalgh==7.or.SDEalgh==11) then
            ...
            if(do_sparse=='Y') then
               ...
               !---------------------------------------------------------------------
               call effective_field_cpu(Natom,Mensemble,1,Natom,  &
      ...
      call timing(0,'Measurement   ','OF')
   end subroutine sd_mphase_cpu

end module sd_driver_cpu
