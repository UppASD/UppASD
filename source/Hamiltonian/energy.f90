!> Routine for calculating the total energy of the system
!> @author
...
contains
  ...
  !> Calculates the total energy and the term projected contributions to the energy
...
10005 format (es12.4,23es16.8)
  ...
  !> Simplified version of calc_energy subroutine
  !! @todo Check consistency with the effective field calculation in heisge()
  !! @todo Replace use of unit length magnetic vectors emom to full length vectors emomM
