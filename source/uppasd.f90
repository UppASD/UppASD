...
contains
   ...
   subroutine cleanup_simulation()
    ...
    if (do_multiscale) then
      ...
      if((do_ralloy==1.or.do_ralloy==2).or.oldformat) call allocate_chemicaldata(flag=-1)
      if((do_ralloy==1.or.do_ralloy==2).or.oldformat) call allocate_chemicalinput(flag=-1)
