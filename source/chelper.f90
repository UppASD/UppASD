...
contains
   ...
   subroutine FortranData_Initiate(stt,btorque)
      ...
      call FortranData_setConstants(stt,SDEalgh,rstep,nstep,Natom,Mensemble,        &
         ...
         initexc,ham_inp%do_dm,ham%max_no_dmneigh, ham_inp%do_jtensor, ham_inp%do_anisotropy, nHam, Temp, ipmcnphase)
      ...
      call FortranData_setMatrices(ham%ncoup,ham%nlist,ham%nlistsize,&
         ...
         mmom2,mmomi,ham%dm_vect,ham%dmlist,ham%dmlistsize, ham%j_tens, ham%kaniso, ham%eaniso, ham%taniso, ham%sb, ham%aHam, ipTemp, ipmcnstep)
