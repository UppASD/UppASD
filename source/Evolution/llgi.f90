...
contains
  ...
  !> First step (predictor) of the Heun solver for the LLG-I eq, calculates the stochastic field preform update
  ...
  !> Second step of solver, calculates the corrected effective field from
  ...
  !> Heun solver for LLG-I equation
  ...
  !> Allocates work arrays for the Heun-I solver
