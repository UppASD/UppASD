...
!> Read initial phase site dependent damping
...
!> Read initial phase site dependent damping for random alloy
...
!> Read measurement phase site dependent damping
...
!> Read measurement phase site dependent random alloy
...
!> Allocate arrays for input for Hamiltonian
