...
class ASDVizMenu():
    ...
    def ASDMenuCreator(self,ASDMainWindow):
        ...
        exit = QtGui.QAction('Exit', ASDMainWindow)
        exit.setShortcut('Ctrl+Q')
        exit.setStatusTip('Exit application')
        ASDMainWindow.connect(exit, QtCore.SIGNAL('triggered()'), QtCore.SLOT('close()'))
        ...
        self.mode_group=QtGui.QActionGroup(ASDMainWindow)
        self.mode_group.setExclusive(True)

        self.restart = QtGui.QAction('Restart',ASDMainWindow)
        ...
        self.moments = QtGui.QAction('Moments', ASDMainWindow)
        ...
        self.neighbours = QtGui.QAction('Neighbours',ASDMainWindow)
        ...
        # Creates a QtGui action that will be used to take an snapshot
        self.snap = QtGui.QAction('Snapshot', ASDMainWindow)
        ...
        self.ProgressBar = QtGui.QProgressBar(ASDMainWindow)
        ...
        self.Select_struct = QtGui.QAction("Select struct file",fileMenu)
        ...
        self.Select_KMC = QtGui.QAction("Select KMC file",fileMenu)
        ...
        ASDVizMenu.png_snap = QtGui.QAction("Saving '.png'",snapMenu,checkable=True)
        ASDVizMenu.png_snap.setChecked(True)

        ASDVizMenu.pov_snap = QtGui.QAction("Saving '.pov'",snapMenu,checkable=True)
        ...
        Dens_menu=QtGui.QMenu("Magnetization Density",ASDMainWindow)
        # Adding an action for the visibility of the density
        self.Density_act = QtGui.QAction("Display",Dens_menu,checkable=True)
        ...
        Dens_proj_group=QtGui.QActionGroup(ASDMainWindow)
        Dens_proj_group.setExclusive(True)
        # X Projection
        self.Density_proj_x = QtGui.QAction("X Proj.",Dens_proj_group,checkable=True)
        self.Density_proj_x.setChecked(False)
        self.Density_proj_x.toggled.connect(ASDVizMenu.ASDOptions.set_color_x)
        # Y Projection
        self.Density_proj_y = QtGui.QAction("Y Proj.",Dens_proj_group,checkable=True)
        self.Density_proj_y.setChecked(False)
        self.Density_proj_y.toggled.connect(ASDVizMenu.ASDOptions.set_color_y)
        # Z Projection
        self.Density_proj_z = QtGui.QAction("Z Proj.",Dens_proj_group,checkable=True)
        ...
        # Adding a submenu for the Magnetization Density option
        Spins_menu=QtGui.QMenu("Atomic Spins",ASDMainWindow)
        # Adding an action for the visibility of the density
        self.Spins_act = QtGui.QAction("Display",Spins_menu,checkable=True)
        self.Spins_act.setChecked(False)
        self.Spins_act.toggled.connect(ASDVizMenu.ASDOptions.toggle_spins)
        # Creating an action group for the colors, of that way only one option can be selected
        Spins_proj_group=QtGui.QActionGroup(ASDMainWindow)
        Spins_proj_group.setExclusive(True)
        # X Projection
        self.Spin_proj_x = QtGui.QAction("X Proj.",Spins_proj_group,checkable=True)
        self.Spin_proj_x.setChecked(False)
        self.Spin_proj_x.toggled.connect(ASDVizMenu.ASDOptions.set_spins_color_x)
        # Y Projection
        self.Spin_proj_y = QtGui.QAction("Y Proj.",Spins_proj_group,checkable=True)
        self.Spin_proj_y.setChecked(False)
        self.Spin_proj_y.toggled.connect(ASDVizMenu.ASDOptions.set_spins_color_y)
        # Z Projection
        self.Spin_proj_z = QtGui.QAction("Z Proj.",Spins_proj_group,checkable=True)
        ...
        self.axes_menu_check = QtGui.QAction("Display Axes",VizMenu,checkable=True)
        self.axes_menu_check.setChecked(True)
        self.axes_menu_check.toggled.connect(ASDVizMenu.ASDOptions.toggle_Axes)
        self.ScalarBar_menu_check = QtGui.QAction("Display Color bar",VizMenu,checkable=True)
        ...
        self.dir_menu_check = QtGui.QAction("Display Moments directions",VizMenu,checkable=True)
        ...
        self.cont_menu_check=QtGui.QAction("Display Contours",VizMenu,checkable=True)
        self.cont_menu_check.setChecked(True)
        ...
        Colors_menu=QtGui.QMenu("Color maps",ASDMainWindow)
        Colors_group=QtGui.QActionGroup(ASDMainWindow)
        Colors_group.setExclusive(True)
        # Coolwarm color map
        self.color_map_menu_Coolwarm = QtGui.QAction("Coolwarm Color Map",Colors_group,checkable=True)
        ...
        self.color_map_menu_BlackBody = QtGui.QAction("Black Body Color Map",Colors_group,checkable=True)
        ...
        # RdGy Color map
        self.color_map_menu_RdGy = QtGui.QAction("RdGy Color Map",Colors_group,checkable=True)
        self.color_map_menu_RdGy.setChecked(False)
        self.color_map_menu_RdGy.toggled.connect(ASDVizMenu.ASDOptions.set_RdGy_lut)
        # Spectral Color map
        self.color_map_menu_Spectral = QtGui.QAction("Spectral Color Map",Colors_group,checkable=True)
        ...
        ########################################################################
        SpinsGlyphs=QtGui.QMenu("Color maps",ASDMainWindow)
        SpinsGlyphs=QtGui.QActionGroup(ASDMainWindow)
        SpinsGlyphs.setExclusive(True)
        # Set the spins glyphs to be arrows
        self.spins_to_arrows = QtGui.QAction("Arrows",SpinsGlyphs,checkable=True)
        ...
        self.spins_to_cubes = QtGui.QAction("Cubes",SpinsGlyphs,checkable=True)
        ...
        self.spins_to_spheres = QtGui.QAction("Spheres",SpinsGlyphs,checkable=True)
        ...
        self.spins_to_cones = QtGui.QAction("Cones",SpinsGlyphs,checkable=True)
        ...
        self.reset_camera_menu=QtGui.QAction("Reset Camera",CameraMenu)
        self.reset_camera_menu.triggered.connect(ASDMainWindow.CameraHandling)

        self.projection_camera_menu=QtGui.QAction("Parallel Projection",CameraMenu,checkable=True)
