...
ams=np.genfromtxt("ams.honeycom.out")
na=ams.shape
print(na)
phondisp=np.genfromtxt("phondisp.honeycom.out")
nb=phondisp.shape
print(nb)
...
ax3.plot(ams[:,na[1]-1],phondisp[:,4], c='b', linestyle='-', marker='s', ms='4')
ax3.plot(ams[:,na[1]-1],phondisp[:,5], c='m', linestyle='--', marker='s', ms='4')
ax3.plot(ams[:,na[1]-1],phondisp[:,6], c='c', linestyle='-.', marker='s', ms='4')
ax3.axis('tight')
pp.xticks((0.00, 8.66, 13.66, 23.660), ('$\Gamma$', '$M$', '$K$', '$\Gamma$'), fontsize='x-large')
#pp.show()
