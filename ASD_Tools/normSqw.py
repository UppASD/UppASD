...
if got_sqw:
    ...
    sqw_perp=ndimage.gaussian_filter1d(sqw_perp,sigma=sigma_w,axis=0,mode='reflect')
    ...
    np.savetxt('sqw_norm.'+simid+'.dat',np.column_stack((q.astype(int),w.astype(int),sqw_x,sqw_y,sqw_z,sqw_tot,sqw_perp)),fmt='%7i %7i   %10.4e %10.4e %10.4e   %10.4e  %10.4e')
