...
class vtkTimerCallback():
    ...
    def execute(self, obj, event):
        vecz, colz = (readVectorsData(directionsFile,
                      self.timer_count, nrAtoms, Nmax))
        #print "Set data.."
...
planeCut.SetInputArrayToProcess(0, 0, 0, vtk.vtkDataObject(
).FIELD_ASSOCIATION_POINTS, vtk.vtkDataSetAttributes().SCALARS)
...
planeClip.SetInputArrayToProcess(0, 0, 0, vtk.vtkDataObject(
).FIELD_ASSOCIATION_POINTS, vtk.vtkDataSetAttributes().SCALARS)
